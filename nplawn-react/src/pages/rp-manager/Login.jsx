...
export default function ManagerPortalLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await portalLogin(username.trim(), password, 'manager');
      navigate('/rp-manager/dashboard', { replace: true });
    } catch (err) {
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">Route Planner — Branch Manager</div>
          </div>
        </div>

        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          <h1 className="text-xl font-bold text-gray-900 mb-6 text-center">Manager Sign In</h1>
